...
(function() {
  ...
  zappa.app = function(func, options) {
    var app, apply_helpers, client, client_bundle_simple, client_bundled, context, helpers, io, partials, postrenders, real_root, request_socket, root, route, socket_session, verb, ws_handlers, zappa_used, _fn, _i, _len, _ref2;
    if (options == null) {
      options = {};
    }
    context = {
    ...
    if (io != null) {
      context.get('/zappa/socket/:channel_name/:socket_id', function() {
        var channel_name, io_client, io_data, key, socket_id, _base, _ref3;
        if (this.session != null) {
          channel_name = this.params.channel_name;
          socket_id = this.params.socket_id;
          if ((_ref3 = (_base = this.session).__socket) == null) {
            _base.__socket = {};
          }
